...
i = 1
s = paste0('title: "Amplicon Data Analysis Pipeline (', c('Bootstrap', 'Tufte'), ' Style)"')
for (fmt in c('html_book', 'tufte_html_book')) {
  ...
  i = i + 1
  bookdown::publish_book(paste0('Amplicon Data Analysis Pipeline', i))
}
unlink('_book', recursive = TRUE)
...
bookdown::publish_book('Amplicon Data Analysis Pipeline')
